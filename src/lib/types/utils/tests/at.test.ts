...
test("At:positive index", () => {
    expectTypeOf(null! as At<TupleA, 2>).toEqualTypeOf<TupleA[2]>()
})
test("At:positive index (undefined)", () => {
    expectTypeOf(null! as At<TupleA, 1000>).toBeUndefined()
})
test("At:negative index", () => {
    expectTypeOf(null! as At<TupleA, -3>).toEqualTypeOf<TupleA[2]>()
})
test("At:negative index (undefined)", () => {
    expectTypeOf(null! as At<TupleA, -1000>).toBeUndefined()
})
test("At:union", () => {
    expectTypeOf(null! as At<TupleA | TupleB, -3 | 1 | 1000>).toEqualTypeOf<
